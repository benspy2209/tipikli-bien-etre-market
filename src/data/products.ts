...
export const products: Product[] = [
  ...
  // The Grater Cookbooks - Livres et E-books
  {
    ...
    description: "Le guide complet pour maîtriser The Grater - Version papier",
    ...
    price: 20,
    image: getProductImage("The grater, le livre (version papier)"),
    category: "grater-cookbooks",
    type: "physical",
    badge: "Référence",
    features: ["Version papier premium", "Disponible en 3 langues", "Recettes exclusives", "Format pratique"]
  },
  {
    id: "grater-ebook",
    ...
    type: "digital",
    badge: "Numérique",
    features: ["Format PDF", "Téléchargement instantané", "Recettes exclusives", "Écologique"]
  },
  {
    id: "ebook-garlic-fr",
    ...
    type: "digital",
    badge: "🇫🇷 Français",
    features: ["Guide nutritionnel", "Recettes spécialisées", "Conseils santé", "Format PDF"]
  },
  {
    id: "ebook-garlic-en",
    ...
    type: "digital",
    badge: "🇬🇧 English",
    features: ["Health benefits", "Cultural history", "Recipe collection", "PDF format"]
  },
  {
    id: "ebook-garlic-nl",
    ...
    type: "digital",
    badge: "🇳🇱 Nederlands",
    features: ["Gezondheidsvoordelen", "Culinaire geschiedenis", "Receptenverzameling", "PDF formaat"]
  },
  {
    id: "ebook-ginger-fr",
    ...
    type: "digital",
    badge: "🇫🇷 Français",
    features: ["Histoire fascinante", "Bienfaits santé", "Recettes traditionnelles", "Format PDF"]
  },
  {
    id: "ebook-ginger-en",
    ...
    type: "digital",
    badge: "🇬🇧 English",
    features: ["Cultural journey", "Health benefits", "Traditional recipes", "PDF format"]
  },
  {
    id: "ebook-ginger-nl",
    ...
    type: "digital",
    badge: "🇳🇱 Nederlands",
    features: ["Culturele reis", "Gezondheidsvoordelen", "Traditionele recepten", "PDF formaat"]
  },
